...
const b2bGoods = {
  ...
  2: {
    ...
    primaryImage: 'http://img.alicdn.com/img/i2/109580487/O1CN01J1edho1FT5vWoWpJN_!!4611686018427384007-0-saturn_solar.jpg',
    images: [
      'http://img.alicdn.com/img/i2/109580487/O1CN01J1edho1FT5vWoWpJN_!!4611686018427384007-0-saturn_solar.jpg',
      'http://img.alicdn.com/img/i2/2354290166/O1CN01y7BDMY1D64mAW9ifQ_!!4611686018427387382-0-saturn_solar.jpg'
    ],
    price: 38000, // 380.00元
    originPrice: 55000, // 550.00元
    minSalePrice: 38000,
    maxSalePrice: 38000,
    maxLinePrice: 55000,
    // B2B字段
...
export function genGood(id, available = 1) {
  console.log('生成B2B商品模拟数据, ID:', id);

  // 优先使用B2B数据
  if (b2bGoods[id]) {
    console.log('找到B2B商品数据:', b2bGoods[id].title);
    return b2bGoods[id];
  }

  // 默认返回第一个B2B商品
  console.log('使用默认B2B商品数据');
  return {
    ...b2bGoods[1],
    spuId: parseInt(id),
  };
